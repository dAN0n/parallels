...
int main(int argc, char* argv[]) {
	...
	// time[0] = defaultProcess(text);
	// time[1] = pthreadProcess(text, threadCount);
	// time[2] = ompProcess(text, threadCount);

	// cout << "Words: " << getWordCount(wordDict[0]) << " Threads: " << threadCount << endl;
	// cout << "[Default]  [Pthread]  [  OMP  ]" << endl;
	// cout << fixed << setw(9) << time[0] << "  " << fixed << setw(9) << time[1] << "  " << fixed << setw(9) << time[2] << endl;
